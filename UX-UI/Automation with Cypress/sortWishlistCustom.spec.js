...
describe("Sort by in Wishlist",()=>{
    ...
    it("Test - Sortare proprie", ()=>{
        ...
        cy.get('.options > :nth-child(7)').invoke('show').click({force: true});  
        cy.get('[data-sort-price="6.9"] > .state-nonote > .enty-container > .wishlist-drag-drop-handle').dro
