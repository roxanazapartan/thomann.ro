...
- The product on which tests have been conducted is the web application www.thomann.ro. 
- The scope of this testing project is to check out if the main functionalities of the web application are working accordingly.  
- The main functionalities have been set to: Account, “Lista de dorinte”, “Cosul de cumpărături”, “Homepage”.



Short Story About Thomann
